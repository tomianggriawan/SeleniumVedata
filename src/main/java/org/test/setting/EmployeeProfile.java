...
import org.test.common.TestReportManager;
...
public class EmployeeProfile extends BasePage {
    ...
    public EmployeeProfile(WebDriver driver) {
        ...
        // (misal: "Permanen", "Kontrak", "Aktif") — dipilih otomatis dari opsi yang tersedia
        ...
        int age = jobTitle.contains("Manager") || jobTitle.contains("Supervisor") ? 28 + rand.nextInt(15) : 18 + rand.nextInt(8);
    ...
    public static void main(String[] args) {
        try {
            ...
            reporter.generateHtmlReport("employee-test-report.html");
            cleanDummyPhoto();
            chrome.quit();
        }
    }
    ...
    public EmployeeProfile testCreateEmployeeSuccess() {
        ...
        try {
            ...
            reporter.logPass("Karyawan baru '" + empCode + "' (" + firstName + " " + lastName + ") berhasil disimpan dan diverifikasi di tabel list.");
        } catch (Throwable e) {
    ...
    public EmployeeProfile testUpdateEmployee() {
        ...
        try {
            ...
            reporter.logStep("Ubah First Name menjadi '" + updatedFirstName + "' dan Last Name menjadi '" + updatedLastName + "'...");
            employeePage.fillPersonalIdentity(
            ...
            reporter.logPass("Karyawan '" + empCode + "' berhasil diupdate namanya menjadi '" + updatedFirstName + " " + updatedLastName + "'.");
        } catch (Throwable e) {
    ...
    public void testCreateEmployeeFail_MissingMandatoryFields() {
        ...
        try {
            ...
            if (!currentUrl.contains("/form")) {
                throw new AssertionError("Sistem mengizinkan simpan form kosong! (Browser dialihkan dari halaman /form)");
            }
            ...
            reporter.logPass("Validasi sukses. Sistem berhasil memblokir penyimpanan data kosong. Ditemukan " + errors.size() + " pesan error validasi: " + errors);
    ...
    public void testCreateEmployeeFail_EmptyDropdown() {
        ...
        try {
            ...
            reporter.logStep("Mengisi Job Title dengan pilihan tidak valid 'NonExistentJob123' untuk memicu deteksi empty dropdown...");
            try {
                employeePage.fillPositionInfo("NonExistentJob123", null, null);
                
                // Jika tidak melempar exception, berarti handling dropdown gagal
                reporter.logFail("Automation framework tidak mendeteksi dropdown kosong / ketiadaan data pilihan.", null);
                ...
                reporter.logPass("Automation framework sukses menangkap error ketiadaan data dropdown (FAIL Status). Detail Exception: " + e.getMessage());
            }
    ...
    // ==================== File helpers for mock photo upload ====================
